...
// Source: D:\code\GOcode\basic-go\webook\internal\service\user.go
//
// Generated by this command:
//
//	mockgen -source=D:\code\GOcode\basic-go\webook\internal\service\user.go -package=svcmocks -destination=D:\code\GOcode\basic-go\webook\internal\service\mocks\user.mock.go
//
...
// UpdateNoeSensitiveInfo mocks base method.
func (m *MockUserService) UpdateNoeSensitiveInfo(ctx context.Context, user domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateNoeSensitiveInfo", ctx, user)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateNoeSensitiveInfo indicates an expected call of UpdateNoeSensitiveInfo.
func (mr *MockUserServiceMockRecorder) UpdateNoeSensitiveInfo(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateNoeSensitiveInfo", reflect.TypeOf((*MockUserService)(nil).UpdateNoeSensitiveInfo), ctx, user)
}

...
// Source: D:\code\GOcode\basic-go\webook\internal\repository\code.go
//
...
func (m *MockCodeRepository) Story(ctx context.Context, biz, phone, code string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Story", ctx, biz, phone, code)
	ret0, _ := ret[0].(error)
	return ret0
}

// Story indicates an expected call of Story.
func (mr *MockCodeRepositoryMockRecorder) Story(ctx, biz, phone, code any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Story", reflect.TypeOf((*MockCodeRepository)(nil).Story), ctx, biz, phone, code)
}
